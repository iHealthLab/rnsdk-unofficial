...
module.exports = {
    /**
     * Notify event type for AM3S.("event_notify_am3s")
     */
    Event_Notify: RCTModule.Event_Notify,
    /**
     * Get AM3S device's IDPS information.
     * <ul>
     * <li>This is an asynchronous call, it will return immediately.</li>
     * <li>If get successfully, following event will be emit:<br/>
     * {@link module:AM3SModule.Event_Notify AM3SModule.Event_Notify("event_notify_am3s")}<br/>
     ...
     * DeviceEventEmitter.addListener(AM3SModule.Event_Notify, function (e: Event){});
     * </li>
     * </ul>
